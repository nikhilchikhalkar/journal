    ...
    <Box sx={{ padding: '20px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
      ...
      <Box sx={{ marginY: '20px' }}>
        <Typography variant="body1" align="justify">
          IOSR Journals is a self-supporting organization and does not receive funding from any institution/government. 
          ...
          Being an Open Access Journal, IOSR Journals does not receive payment for subscriptions as the journals are freely 
