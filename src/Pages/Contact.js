...
const Contact = () => {
  return (
    <Container>
      <Grid container bgcolor="#f5f5f5" spacing={4} sx={{ py: 4, marginTop:"10px", borderRadius:"10px" }}>
        {/* Contact Form */}
        <Grid item xs={12} md={6}>
          ...
          <form >
            <input type="hidden" name="_token" value="wRNJnQA7MD2SX3oNaOccGHNzh3Gh1lU34aPz9qtm" />
          ...
          <Box>
            <Box display="flex" alignItems="center" mb={2}>
              ...
              <Typography variant="body1">
                ...
                <br />
                H. No.: 1-8-32/39 , Bapu Bagh, Ram Gopalpet Police Station, Secunderabad - 500 003, Telangana, India.
              </Typography>
            </Box>
            <Box display="flex" alignItems="center" mb={2}>
            ...
            <Box display="flex" alignItems="center" mb={2}>
              ...
              <Typography variant="body1">
                <strong>Email:</strong> <a href="mailto:info@hbicsolutions.in">info@hbicsolutions.in</a>
              </Typography>
            </Box>
